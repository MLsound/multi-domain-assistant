...
- [1. Setup & Installation](#1-setup--installation)
    ...
    - [3. Containers build](#3-containers-build)
    - [4. Alternative: Manual Execution](#4-manual-execution-alternative)
- [2. API Reference](#2-api-reference)
- [3. Evaluation](#3-evaluation)
- [4. Observability & Tracing (MLflow)](#4-observability-tracing-mlflow)
- [5. Testing](#5-testing)
