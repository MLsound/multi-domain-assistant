...
def test_science_query_routes_to_science_domain(rag_graph) -> None:
    """A science-domain query must have Science as dominant_category in the result."""
    result = rag_graph.app.invoke(
...
def test_science_query_returns_non_empty_response(rag_graph) -> None:
...
def test_help_override_applies_correct_probability_weights(rag_graph) -> None:
    """
